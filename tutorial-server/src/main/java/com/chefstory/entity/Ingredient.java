 ...
 * @since 09/05/21
 */
@Data @Accessors(chain = true) @Entity(name = "ingredient")
@Table(indexes = {@Index(columnList = "category"), @Index(columnList = "title")}) @JsonInclude(JsonInclude.Include.NON_NULL)
@ToString
